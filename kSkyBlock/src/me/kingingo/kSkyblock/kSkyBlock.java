...
public class kSkyBlock extends JavaPlugin {
	...
	public void onEnable(){
		...
		new MemoryFix(this);
		new ChatListener(this,permissionManager);
		...
		this.cmd.register(CommandURang.class, new CommandURang());	
		...
		new TeleportManager(getCmd(), getPermissionManager(), 5);
		new SpawnListener(this,Bukkit.getWorld("world"),permissionManager,cmd);
