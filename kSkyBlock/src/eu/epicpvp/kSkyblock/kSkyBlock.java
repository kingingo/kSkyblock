...
import eu.epicpvp.kSkyblock.Commands.CommandSkyStats;
...
import eu.epicpvp.kcore.Achievements.BillGates;
import eu.epicpvp.kcore.Achievements.BlockForBlock;
import eu.epicpvp.kcore.Achievements.BobTheDestroyer;
import eu.epicpvp.kcore.Achievements.LevelUP;
import eu.epicpvp.kcore.Achievements.NiceProduct;
import eu.epicpvp.kcore.Achievements.Obsession;
import eu.epicpvp.kcore.Achievements.PureMagic;
import eu.epicpvp.kcore.Achievements.SerieKiller;
import eu.epicpvp.kcore.Achievements.Shopperholik;
import eu.epicpvp.kcore.Achievements.TheWalkingDead;
...
import eu.epicpvp.kcore.Listener.FarmBoosterListener.FarmBoosterListener;
...
public class kSkyBlock extends JavaPlugin {
	...
	public void onEnable() {
		try {
			...
			this.client = UtilServer.createClient(this, ClientType.OTHER, getConfig().getString("Config.Client.Host"),
					getConfig().getInt("Config.Client.Port"), "Sky");
			this.mysql = new MySQL(getFConfig().getString("Config.MySQL.User"),
					getFConfig().getString("Config.MySQL.Password"), getFConfig().getString("Config.MySQL.Host"),
					getFConfig().getString("Config.MySQL.DB"), this);
			this.permissionManager = new PermissionManager(this, GroupTyp.SKY);
			this.statsManager = StatsManagerRepository.getStatsManager(GameType.SKYBLOCK);
			...
			UtilServer.getGemsShop(new GemsShop(ServerType.SKYBLOCK));
			...
			this.teleport = new TeleportManager(getCmd(), getPermissionManager());
			this.perkManager = new PerkManager(this,
					new Perk[] { new PerkStrength(), new PerkNoPotion(PotionEffectType.POISON), new PerkNoWaterdamage(),
							...
							new PerkDoubleXP(), new PerkDropper(), new PerkGetXP(), new PerkPotionClear(),
							new PerkItemName(cmd) });
			...
			UtilServer.getDeliveryPet(new DeliveryPet(UtilInv.getBase(), null,
					new DeliveryObject[] { new DeliveryObject(
							new String[] { "", "§7Click for Vote!", "", "§ePvP Rewards:", "§7   200 Epics",
							...
							new DeliveryObject(
									new String[] { "§aOnly for §eVIP§a!", "", "§ePvP Rewards:", "§7   200 Epics",
											"§7   10 Level", "", "§eGame Rewards:", "§7   200 Coins",
											"§7   2x TTT Paesse", "", "§eSkyBlock Rewards:", "§7   200 Epics",
											"§7   2x Diamonds", "§7   2x Iron Ingot", "§7   2x Gold Ingot" },
									PermissionType.DELIVERY_PET_VIP_WEEK, true, 11, "§cRank §eVIP§c Reward",
									Material.getMaterial(342), Material.MINECART, new Click() {
										...
										public void onClick(Player p, ActionType a, Object obj) {
											...
											p.sendMessage(TranslationHandler.getText(p, "PREFIX")
													+ TranslationHandler.getText(p, "MONEY_RECEIVE_FROM",
															new String[] { "§bThe Delivery Jockey!", "200" }));
										}

									}, TimeSpan.DAY * 7),
							new DeliveryObject(
									new String[] { "§aOnly for §6ULTRA§a!", "", "§ePvP Rewards:", "§7   300 Epics",
											"§7   15 Level", "", "§eGame Rewards:", "§7   300 Coins",
											"§7   2x TTT Paesse", "", "§eSkyBlock Rewards:", "§7   300 Epics",
											"§7   4x Diamonds", "§7   4x Iron Ingot", "§7   4x Gold Ingot" },
									PermissionType.DELIVERY_PET_ULTRA_WEEK, true, 12, "§cRank §6ULTRA§c Reward",
									Material.getMaterial(342), Material.MINECART, new Click() {
										...
										public void onClick(Player p, ActionType a, Object obj) {
											...
											p.sendMessage(TranslationHandler.getText(p, "PREFIX")
													+ TranslationHandler.getText(p, "MONEY_RECEIVE_FROM",
															new String[] { "§bThe Delivery Jockey!", "300" }));
										}

									}, TimeSpan.DAY * 7),
							new DeliveryObject(
									new String[] { "§aOnly for §aLEGEND§a!", "", "§ePvP Rewards:", "§7   400 Epics",
											"§7   20 Level", "", "§eGame Rewards:", "§7   400 Coins",
											"§7   3x TTT Paesse", "", "§eSkyBlock Rewards:", "§7   400 Epics",
											"§7   6x Diamonds", "§7   6x Iron Ingot", "§7   6x Gold Ingot" },
									PermissionType.DELIVERY_PET_LEGEND_WEEK, true, 13, "§cRank §5LEGEND§c Reward",
									Material.getMaterial(342), Material.MINECART, new Click() {
										...
										public void onClick(Player p, ActionType a, Object obj) {
											...
											p.sendMessage(TranslationHandler.getText(p, "PREFIX")
													+ TranslationHandler.getText(p, "MONEY_RECEIVE_FROM",
															new String[] { "§bThe Delivery Jockey!", "400" }));
										}

									}, TimeSpan.DAY * 7),
							new DeliveryObject(
									new String[] { "§aOnly for §bMVP§a!", "", "§ePvP Rewards:", "§7   500 Epics",
											"§7   25 Level", "", "§eGame Rewards:", "§7   500 Coins",
											"§7   3x TTT Paesse", "", "§eSkyBlock Rewards:", "§7   500 Epics",
											"§7   8x Diamonds", "§7   8x Iron Ingot", "§7   8x Gold Ingot" },
									PermissionType.DELIVERY_PET_MVP_WEEK, true, 14, "§cRank §bMVP§c Reward",
									Material.getMaterial(342), Material.MINECART, new Click() {
										...
										public void onClick(Player p, ActionType a, Object obj) {
											...
											p.sendMessage(TranslationHandler.getText(p, "PREFIX")
													+ TranslationHandler.getText(p, "MONEY_RECEIVE_FROM",
															new String[] { "§bThe Delivery Jockey!", "500" }));
										}

									}, TimeSpan.DAY * 7),
							new DeliveryObject(
									new String[] { "§aOnly for §bMVP§c+§a!", "", "§ePvP Rewards:", "§7   600 Epics",
											"§7   30 Level", "", "§eGame Rewards:", "§7   600 Coins",
											"§7   4x TTT Paesse", "", "§eSkyBlock Rewards:", "§7   600 Epics",
											"§7   10x Diamonds", "§7   10x Iron Ingot", "§7   10x Gold Ingot" },
									PermissionType.DELIVERY_PET_MVPPLUS_WEEK, true, 15, "§cRank §bMVP§e+§c Reward",
									Material.getMaterial(342), Material.MINECART, new Click() {
										...
										public void onClick(Player p, ActionType a, Object obj) {
											...
											p.sendMessage(TranslationHandler.getText(p, "PREFIX")
													+ TranslationHandler.getText(p, "MONEY_RECEIVE_FROM",
															new String[] { "§bThe Delivery Jockey!", "600" }));
										}

									}, TimeSpan.DAY * 7),
							new DeliveryObject(
									new String[] { "§7/twitter [TwitterName]", "", "§ePvP Rewards:", "§7   300 Epics",
											"§7   15 Level", "", "§eGame Rewards:", "§7   300 Coins", "",
											"§eSkyBlock Rewards:", "§7   300 Epics", "§7   15 Level" },
									PermissionType.DELIVERY_PET_TWITTER, false, 34, "§cTwitter Reward",
									Material.getMaterial(351), 4, new Click() {

										@Override
										public void onClick(Player p, ActionType a, Object obj) {
											// String s1 =
											// getMysql().getString("SELECT
											// twitter FROM BG_TWITTER WHERE
											// uuid='"+UtilPlayer.getRealUUID(p)+"'");
											// if(s1.equalsIgnoreCase("null")){
											// p.sendMessage(Language.getText(p,"PREFIX")+Language.getText(p,
											// "TWITTER_ACC_NOT"));
											// }else{
											// getPacketManager().SendPacket("DATA",
											// new
											// TWIITTER_IS_PLAYER_FOLLOWER(s1,
											// p.getName()));
											// p.sendMessage(Language.getText(p,"PREFIX")+Language.getText(p,
											// "TWITTER_CHECK"));
											// }
					...
					"§bThe Delivery Jockey!", EntityType.CHICKEN, CommandLocations.getLocation("DeliveryPet"),
					ServerType.SKYBLOCK, getHologram(), getMysql()));
			initAchievements();
			this.manager = new SkyBlockManager(this);
			this.cmd.register(CommandSkyStats.class, new CommandSkyStats(manager));
			...
			AACHack a = new AACHack(ServerType.SKYBLOCK.getName());
			...
			new SkyBlockGildenManager(getManager(), getMysql(), getCmd(), getStatsManager());
			
			setTutorialCreature(CommandLocations.getLocation("tutorial"));
			UtilServer.getLagListener(); //Init
	...
	public void setTutorialCreature(Location loc) {
		...
		page.setItem(28,
				UtilItem.Item(new ItemStack(Material.GRASS),
						new String[] { "§8»§7 Mit '§6/Is erstellen§7' kannst du eine eingene Insel generieren. ",
								"§7  Anschließend kannst du mit '§6/Is§7' auf alle Funktionen und",
								"§7  Einstellungen deiner Insel zugreifen. ",
								"§7  Mit '§6/Spawn§7' kommst du zu der Spawn-Insel zurück. " },
						"§6Insel"));

		page.setItem(38,
				UtilItem.Item(new ItemStack(Material.IRON_HELMET),
						new String[] { "§8»§7 Mit dem '§6/Gilde§7' Befehl kannst",
								"§7  du eine eigene Gemeinschaft mit", "§7  deinen Freunden gründen und eine",
								"§7  gemeinsame Gilden-Insel gestalten." },
						"§6Gilde"));

		page.setItem(31,
				UtilItem.Item(new ItemStack(Material.CHEST),
						new String[] { "§8»§7 Mit '§6/Shop§7' kannst du das Shop-Menü öffnen und",
								"§7  unter verschiedenen Kategorien deine",
								"§7  Items auswählen und §6kaufen§7 oder §6verkaufen§7. ",
								"§7  Items kaufen kannst du mit einem links Klick auf",
								"§7  das gewünschte Item und mit einem rechts Klick, ",
								"§7  kannst du deine Items verkaufen. " },
						"§6Shop"));

		page.setItem(24, UtilItem.Item(new ItemStack(Material.SIGN),
				new String[] { "§8»§7 Mit §7'§6[UserStore]§7' in der erste Zeile und den",
						"§7  gewünschten Preis in der zweiten, kannst",
						"§7  du deinen eigenen Shop erstellen. Darunter muss ",
						"§7  eine Kiste, mit nur dem Item, welches du im", "§7  Shop anbieten möchtest sein. Sobald du",
						"§7  dies gemacht hast wird dir der Befehl §7'§6/Mystore§7'",
						"§7  freigeschalten. Dies ermöglicht dir die", "§7  Administration deiner Shop's.",
						"§7  Du kannst mit '§6/Setusershop§7' deinen", "§7  Shop-Warp setzen und dich mit",
		...
		page.setItem(42,
				UtilItem.Item(new ItemStack(Material.TRIPWIRE_HOOK),
						new String[] { "§8»§7 Mit dem §7'§6/Handel§7' Befehl kannst",
								"§7  du sicher mit anderen Spielern handeln.", "§7  Du kannst deine Items in das linke",
								"§7  Feld ziehen und siehst dann im rechten, ",
								"§7  welche Items dir im Tausch dagegen angeboten",
								"§7  werden. Unten kannst du dann auf §7'§6Accept§7'",
								"§7  das Angebot akzeptieren. Sobald das dann", "§7  auch der Tauschpartner",
								"§7  macht, ist der Handel abgeschlossen. " },
						"§6Handel"));

		page.setItem(34,
				UtilItem.Item(new ItemStack(Material.EMERALD),
						new String[] { "§8»§7 Du kannst mit dem Befehl '§6/Money§7", "§7  deinen Kontostand überprüfen",
								"§7  Mit verschiedensten Farmen kannst du diesen",
								"§7  erhöhen und mit anderen Spielern handeln.", "§7  Du kannst mit",
								"§7  dem Befehl §7'§6/Money send <Spieler <Betrag>§7'",
								"§7  deinen Freunden §6Epics§7 überweisen" },
						"§6Wirtschaft"));
	...
	public void initAchievements() {
		new AchievementsHandler(this, new Achievement[] { new BlockForBlock(createAchievementCallback(5000)),
				new BillGates(GameType.SKYBLOCK, createAchievementCallback(5000)),
				new BobTheDestroyer(createAchievementCallback(5000)), new LevelUP(createAchievementCallback(1000)),
				new NiceProduct(createAchievementCallback(500)),
				new Obsession(StatsKey.SKY_TIME, createAchievementCallback(5000)),
				new PureMagic(createAchievementCallback(1000)), new Shopperholik(createAchievementCallback(1000)),
				new TheWalkingDead(createAchievementCallback(500)), new SerieKiller(createAchievementCallback(500)) });
	}

	public Callback<Integer> createAchievementCallback(int profit) {
		return new Callback<Integer>() {

			@Override
			public void call(Integer playerId, Throwable exception) {
				StatsManagerRepository.getStatsManager(GameType.SKYBLOCK).add(playerId, StatsKey.MONEY, profit);
				...
				if (UtilPlayer.isOnline(playerId)) {
					...
					if (UtilPlayer.isOnline(loadedplayer.getName())) {
						Bukkit.getPlayer(loadedplayer.getName()).sendMessage(
								TranslationHandler.getText("PREFIX") + "§aDu hast §e" + profit + "§a Epics erhalten.");
					}
				}
			}
		};
